      ...
      <div className={styles.footer__container}>
        <div className={styles.footer_row_top}>
          <div className={styles[`footer__flex-container`]}>
            ...
            <div className={styles.footer__text}>
              <Text type="default" color="grey">
                Fluence Labs sends regular updates about the project. Subscribe
                via email to get notified.
              </Text>
            </div>
          </div>
          <form className={styles.footer__form} onSubmit={handleSubmit}>
            ...
            />
            <span
              className={`${styles.footer__error} ${!isValid && values.email && styles.footer__error_show}`}
            >
            ...
            <div className={styles["footer__flex-column"]}>
              ...
              <div style={{ marginTop: "20px" }}>
                <List>
                  ...
                  <li
                    className={`${styles.footer__item} ${styles.footer__item_disabled} ${styles.footer__item_list_arrow}`}
                  >
