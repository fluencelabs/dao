...
class Test(unittest.TestCase):
    def test_gen_merkle_root_one(self):
        ...
        assert (tree.get_root() == "0xe03d95e6572c9c3d1dc2f310b0148dca89d08d9b8b8459cdc2667344615994d0")
    ...
    def test_gen_merkle_root_two(self):
        ...
        assert (tree.get_root()  == "0x7d29796cd53c0443e4e879329070e45ee2b926c6ac4739540a0091b26c816215")
    ...
    def test_gen_merkle_root_three(self):
        ...
        assert (tree.get_root() == "0x7af560a7d579b81a0d8058bdb07e0700e5fcc454dcc115c97732d644ae53311e")
    ...
    def test_gen_merkle_root_tour(self):
        ...
        assert (tree.get_root() == "0xca22b62c1dec6b20d7fedfe1b9493820b37ae3a0d8ced44d8b1010f49cdc4ea4")
